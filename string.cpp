...
//    std::string::size_type n = atoi(argv[1]);
//    if(n < hex.size())
//    {
//        std::cout<<"your dec is "<< n << std::endl;
//        std::cout<<"the hex is "<< hex[n] <<std::endl;
//    }
//    else
//    {
//        std::cout<< "your dex is out of range" << std::endl;
//        return 0;
//    }
//    return 0;
//}
...
//
//    //3.string类的字符操作
//    string str5 = "helle fucking world";
